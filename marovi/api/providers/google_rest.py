"""
Google provider implementations using REST APIs.

This module provides implementations for Google's Translation using the REST API v2
and Google's Gemini LLM service using the google.generativeai package.
"""
...
#
# Google Translation Provider using REST API v2
#
class GoogleTranslateRestProvider(TranslationProvider):
    """
